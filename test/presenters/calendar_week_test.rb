...
class CalendarWeekTest < ActiveSupport::TestCase
  ...
  test "exclusive flag is readable from the segment" do
    ...
    assert_predicate segment_for(week, exclusive), :exclusive?
    assert_not segment_for(week, open).exclusive?
  end
end
