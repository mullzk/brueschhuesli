...
# Spec for Vorhaben #2 (E-Mail-Infrastruktur), development mail interceptor.
# Commented out until the interceptor exists; activate per Feinplanungs-Schritt.
# The interceptor itself is only registered in development, so these tests call
# it directly. SMTP credentials are stubbed.
